...
def evaluate_call(
    ...
    if isinstance(call.func, ast.Attribute):
        ...
        elif func_name in BASE_PYTHON_ERRORS:
            func = BASE_PYTHON_ERRORS[func_name]
        else:
            raise InterpreterError(
...
def evaluate_name(
    ...
    elif name.id in BASE_PYTHON_ERRORS:
        return BASE_PYTHON_ERRORS[name.id]
...
def get_safe_module(raw_module, dangerous_patterns, authorized_imports, visited=None):
    ...
    for attr_name in dir(raw_module):
        ...
        if any(
            ...
            and pattern not in authorized_imports
...
class PythonInterpreterTool(Tool):
    ...
    output_model = PythonInterpreterOutput
